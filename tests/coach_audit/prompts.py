...
_nutrition_macros = [
    ...
    PromptCase(
        ...
        expected_behavior=["1g/lb", "protein"],
        must_not=["249", "300g"],
        focus_dimensions=["accuracy"],
    ),
    PromptCase(
