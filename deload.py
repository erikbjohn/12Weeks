...
def deload_evidence_text(user_id, week, today) -> str:
    ...
    return (
        ...
        f"- {lt}\n"
        f"- {ckl}\n"
        "FIRST LEVER: fatigue is managed by REDUCING RUNNING VOLUME "
        "(reduce_running in your output), NOT lifting — lifting volume is protected "
        "during this cut (athlete directive 2026-08-30), and the athlete may veto a "
        "lifting deload; his veto is final.\n"
        "EVIDENCE ONLY: your reason (and any reduce_running reason) may cite ONLY "
        "numbers and facts printed in this block. NEVER assert a medical event — "
        "a flare, illness, injury, or condition — that does not appear here; "
        "inventing one (e.g. 'active celiac flare', 2026-09-01) is a firing "
        "offense per rule 20.\n"
