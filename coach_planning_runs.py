...
def generate_week_runs(
    ...
    system = (
        ...
        "2. Z2 runs should hold HR ≤ Z2 ceiling (typically 130-140 for the "
        "   athlete). State the HR ceiling in the detail.\n"
        "3. VO2 intervals: name reps × duration (e.g. 4×4 min at threshold).\n"
        "4. Long run: distance > all other runs in the week.\n"
        "5. Deload weeks: ~70% of prior week's volume per run.\n"
        "6. Build phase: progress long run by 0.5-1 mi/week if streak is clean.\n"
        "7. Strict Z2 days: HR ceiling explicit (e.g. 'HR ≤ 132').\n"
        "8. Match target weekly miles if provided.\n\n"
